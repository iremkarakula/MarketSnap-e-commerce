...
function SnapCard() {
    return (
        <div>
            <h2 className='text-center text-4xl py-10 font-semibold'>Market Snap kartının avantajlarını keşfedin</h2>
            <div className='flex gap-8 justify-center items-center rounded pb-14'>
                <div className=' w-80'>
                ...
                <div className=' w-80 flex flex-col gap-6 items-center justify-center'>
                    ...
                    <Link to="/register" className='underline underline-offset-2 cursor-pointer font-medium'>Hemen üye ol</Link>
                </div>
                <div className=' w-80'>
                    <div className='flex flex-col items-center justify-center p-8 gap-4' >
            ...
            <div className='w-full py-14  bg-gradient-to-r from-gray-200 via-gray-50 to-gray-200 flex flex-col items-center'>
                <h4 className='w-1/2 pb-4 text-center font-semibold text-2xl'>Market Snap uygulamasını indirerek, Snap kart puanlarınızı ve kampanyalarınızı kolayca takip edebilirsiniz.</h4>
                <p className='w-1/2 text-center text-md'>Market Snap uygulamasıyla, biriken puanlarınızı, alışveriş geçmişinizi, size özel kampanyaları ve uygulamadaki tüm yenilikleri kolayca takip edebilirsiniz.</p>
            </div>
            <div className='py-16 flex flex-col items-center justify-center gap-8'>
                <h4 className=' w-1/2 text-center font-medium text-xl'>Market Snap uygulamasını indirmek için buraya tıklayın veya QR kodu ile okutun.</h4>
                ...
                <div className='w-full py-16 bg-gradient-to-r from-gray-200 via-gray-50 to-gray-200'>
                    <h4 className=' py-8 text-center font-semibold text-2xl'>Snap kartınızı marketsnap.com üyeliğinize tanımlamak için şu adımları takip edebilirsiniz.</h4>
